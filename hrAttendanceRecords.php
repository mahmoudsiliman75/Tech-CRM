...
<!-- END:: INCLUDING HEADER -->
    ...
    <div class="attendance-records-cards row mb-2">
      ...
      <div class="col-12 col-md-3">
        <div class="financ-container kt-portlet kt-iconbox kt-iconbox--warning kt-iconbox--animate-fast">
          <div class="kt-portlet__body px-0">
            <div class="kt-iconbox__body">
      ...
      <div class="col-12">
        ...
        <form class="kt-form p-3">
          <div class="row">
            ...
            <div class="form-group col-12 col-md-6">
              <div class="row">
                <label class="col-form-label col-12"> اليوم </label>
                <div class="input-group-prepend col-12">
                  <span class="input-group-text"> <i class="la la-calendar" style="font-size: 18px"></i> </span>
            ...
            <div class="form-group col-12 col-md-6">
              <div class="row">
                <label class="col-form-label col-12"> من الساعة </label>
                <div class="input-group timepicker col-12">
                  <div class="input-group-append">
                    <span class="input-group-text">
                      <i class="la la-clock-o"></i>
                    </span>
                  </div>
                  <input class="form-control" id="kt_timepicker_2" readonly="" placeholder="اختار الساعة" type="text">
                </div>
              </div>
            </div>
            ...
            <div class="form-group col-12 col-md-6">
              <div class="row">
                ...
                <label class="col-form-label col-12"> الى الساعة </label>
                <div class="input-group timepicker col-12">
                  <div class="input-group-append">
                    <span class="input-group-text">
                      <i class="la la-clock-o"></i>
